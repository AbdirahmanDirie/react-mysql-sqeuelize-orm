    ...
    <form onSubmit={handleLogin}>
        <div className="bg-white px-10 py-8 rounded-xl w-screen shadow-xl max-w-sm">
            ...
            <div className="flex items-center border-2 py-2 px-3 rounded-md mb-4">
                ...
                <input className="pl-2 outline-none border-none w-full" type="email" name="email"  value={email}
            ...
            <div className="flex items-center border-2 py-2 px-3 rounded-md">
                ...
                <input className="pl-2 outline-none border-none w-full" type="password" name="password" id="" placeholder="Password"  value={password}
            ...
            <button type="submit" className="mt-6 w-full shadow-xl bg-gradient-to-tr from-blue-600 to-cyan-300 hover:to-blue-700 text-indigo-100 py-2 rounded-md text-lg tracking-wide transition duration-1000">
              {
